...
func SetupRoutes(r *gin.Engine) {
	...
	v1 := r.Group("/api/v1")
	{
		...
		pps := v1.Group("/pps")
		{
			...
			pps.GET("/aware-categorization", ppsCalculationsHandler.GetAWaReCategorization)
			pps.GET("/appropriate-diagnosis", ppsCalculationsHandler.GetAppropriateDiagnosisPercentage)
		}
